  ...
  return (
    <div className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-10 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white text-[#333] my-6 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-md:before:hidden">
        ...
        <ul className="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
          <li className="flex items-center hover:text-blue-500">
            ...
            <a href="javascript:void(0)" className="text-current text-sm ml-3">
              <strong>marketing@blueoceansejahtera.com</strong>
            </a>
          </li>
          <li className="flex items-center text-current hover:text-blue-500">
            ...
            <a href="javascript:void(0)" className="text-current text-sm ml-3">
              <strong>+622122792650 </strong>
            </a>
            <a href="javascript:void(0)" className="text-current text-sm ml-3">
              <strong>+622122792651 </strong>
            </a>
          </li>
        </ul>
      </div>
      <div className="z-10 relative h-full max-md:min-h-[350px]">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.00214342268!2d106.84118481087908!3d-6.263446393698975!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f326dec0fd37%3A0x85f3d76238527a9e!2sPt.%20Blue%20Ocean%20Sejahtera!5e0!3m2!1sid!2sid!4v1712118971885!5m2!1sid!2sid"
          width="600"
          height="450"
          style={{ border: 0 }}
          loading="lazy"
